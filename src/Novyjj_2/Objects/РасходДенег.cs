...
namespace IIS.Novyjj_2
{
    ...
    public class РасходДенег : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Novyjj_2.Банк fБанк;
        ...
        private IIS.Novyjj_2.Поставщики fПоставщики;
        
        private IIS.Novyjj_2.DetailArrayOfПереченьМат fПереченьМат;
        ...
        public virtual IIS.Novyjj_2.Банк Банк
        {
            get
            {
                ...
                IIS.Novyjj_2.Банк result = this.fБанк;
        ...
        [PropertyStorage(new string[] {
                "Поставщики"})]
        [NotNull()]
        public virtual IIS.Novyjj_2.Поставщики Поставщики
        {
            get
            {
                ...
                IIS.Novyjj_2.Поставщики result = this.fПоставщики;
        ...
        public virtual IIS.Novyjj_2.DetailArrayOfПереченьМат ПереченьМат
        {
            get
            {
                ...
                {
                    this.fПереченьМат = new IIS.Novyjj_2.DetailArrayOfПереченьМат(this);
                }
                IIS.Novyjj_2.DetailArrayOfПереченьМат result = this.fПереченьМат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасходДенегE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегE", typeof(IIS.Novyjj_2.РасходДенег));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасходДенегL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегL", typeof(IIS.Novyjj_2.РасходДенег));
                }
            }
        }
    }
