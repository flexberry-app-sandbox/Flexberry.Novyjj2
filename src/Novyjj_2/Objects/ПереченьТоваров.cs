...
namespace IIS.Novyjj_2
{
    ...
    public class ПереченьТоваров : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьТоваровE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьТоваровE", typeof(IIS.Novyjj_2.ПереченьТоваров));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПереченьТоваров : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Novyjj_2.DetailArrayOfПереченьТоваров members)

        // *** End programmer edit section *** (IIS.Novyjj_2.DetailArrayOfПереченьТоваров members)
        ...
        /// </summary>
        public DetailArrayOfПереченьТоваров(IIS.Novyjj_2.ПриходДенег fПриходДенег) : 
                base(typeof(ПереченьТоваров), ((ICSSoft.STORMNET.DataObject)(fПриходДенег)))
        {
        }
        
        public IIS.Novyjj_2.ПереченьТоваров this[int index]
        {
            get
            {
                return ((IIS.Novyjj_2.ПереченьТоваров)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Novyjj_2.ПереченьТоваров dataobject)
        {
